...
<template>
  <YearPickerRoot v-bind="forwarded" v-slot="{ grid }" :default-value="defaultDate" class="w-96 rounded text-label-lg">
    <YearPickerHeader class="flex justify-between p-5 border-b-1 border-b-neutral-400">
