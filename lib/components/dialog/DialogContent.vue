...
<template>
	<DialogPortal>
		...
		<DialogContent
			...
			:class="
				cn(
					'fixed left-1/2 top-1/2 grid w-full -translate-x-1/2 -translate-y-1/2 border bg-white dark:bg-neutral-10 p-2 shadow-lg rounded-xl duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%]',
					props.class
				)
			"
		...
		>
			<DialogTitle />
			<div :class="cn('max-h-[90vh] overflow-y-auto p-10')">
				<slot />
			</div>
		</DialogContent>
	</DialogPortal>
