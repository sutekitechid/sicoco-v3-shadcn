...
export const radioGroupItemVariant = cva(
	'aspect-square h-5 w-5 rounded-full border border-neutral-400 ring-offset-neutral-100 focus:outline-none focus-visible:ring-4 hover:ring-4 disabled:cursor-not-allowed hover:scale-110 transition duration-200 ease-in-out transform',
	{
		variants: {
			variant: {
