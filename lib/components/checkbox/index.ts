...
export const checkboxVariant = cva('peer h-5 w-5 shrink-0 rounded-md border border-neutral-30 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-offset-0 hover:ring-4 disabled:cursor-not-allowed data-[state=checked]:text-neutral-5',
  {
    variants: {
      variant: {
        default:
 ...
 * @returns 
 */
export function determineModelValue(checked: any, value: any, modelValue: any): any {
