...
export const alertVariants = cva(
	'relative w-full rounded-lg border-neutral-200 p-4 [&>svg~*]:pl-7 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-neutral-950 dark:text-neutral-700 dark:border-neutral-800 dark:[&>svg]:text-neutral-50',
	{
		variants: {
			variant: {
				primary:
				...
				warning:
					'bg-warning-50 dark:bg-warning-500 border-warning-200 dark:border-warning-200 dark:text-neutral-50',
				danger:
