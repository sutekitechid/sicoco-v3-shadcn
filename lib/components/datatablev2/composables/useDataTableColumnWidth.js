 ...
 */
export function useDataTableColumnWidth(props, allLeafColumns, sortedNodes, treeOps, getVirtualRowColumns, dummyRowGetter) {
	// ============================
	// REACTIVE STATE
	// ============================
	...
	function captureCell(cell, fieldId) {
		// console.log('capturing cell width:', fieldId, cell?.getBoundingClientRect() || 0, window.getComputedStyle(cell).width)
