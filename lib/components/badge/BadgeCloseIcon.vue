...
/**
 * Props for the BadgeCloseIcon component.
 * - `type`: Specifies the variant type for the badge icon styling.
...
<template>
	<i :class="cn(badgeCloseIconVariants({ type: props.type }), props.class)" />
</template>
