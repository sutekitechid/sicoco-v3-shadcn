...
const SWATCH_DEFS: { family: string; shade: string; class: string; checkClass: string }[] = [
	{ family: 'primary', shade: '50', class: '!bg-primary-subtle', checkClass: 'text-main' },
	{ family: 'primary', shade: '100', class: '!bg-primary-100', checkClass: 'text-main' },
	{ family: 'primary', shade: '200', class: '!bg-primary-200', checkClass: 'text-main' },
	...
	{ family: 'primary', shade: '500', class: '!bg-primary-default', checkClass: 'text-white' },
	...
	{ family: 'secondary', shade: '50', class: '!bg-secondary-subtle', checkClass: 'text-main' },
	{ family: 'secondary', shade: '100', class: '!bg-secondary-100', checkClass: 'text-main' },
	{ family: 'secondary', shade: '200', class: '!bg-secondary-200', checkClass: 'text-main' },
	{ family: 'secondary', shade: '300', class: '!bg-secondary-300', checkClass: 'text-main' },
	{ family: 'secondary', shade: '400', class: '!bg-secondary-400', checkClass: 'text-white' },
	{ family: 'secondary', shade: '500', class: '!bg-secondary-default', checkClass: 'text-white' },
	...
	{ family: 'warning', shade: '50', class: '!bg-warning-subtle', checkClass: 'text-main' },
	{ family: 'warning', shade: '100', class: '!bg-warning-100', checkClass: 'text-main' },
	{ family: 'warning', shade: '200', class: '!bg-warning-200', checkClass: 'text-main' },
	{ family: 'warning', shade: '300', class: '!bg-warning-300', checkClass: 'text-main' },
	{ family: 'warning', shade: '400', class: '!bg-warning-400', checkClass: 'text-main' },
	{ family: 'warning', shade: '500', class: '!bg-warning-default', checkClass: 'text-main' },
	...
	{ family: 'success', shade: '50', class: '!bg-success-subtle', checkClass: 'text-main' },
	{ family: 'success', shade: '100', class: '!bg-success-100', checkClass: 'text-main' },
	{ family: 'success', shade: '200', class: '!bg-success-200', checkClass: 'text-main' },
	{ family: 'success', shade: '300', class: '!bg-success-300', checkClass: 'text-main' },
	{ family: 'success', shade: '400', class: '!bg-success-400', checkClass: 'text-white' },
	{ family: 'success', shade: '500', class: '!bg-success-default', checkClass: 'text-white' },
	...
	{ family: 'danger', shade: '50', class: '!bg-danger-subtle', checkClass: 'text-main' },
	{ family: 'danger', shade: '100', class: '!bg-danger-100', checkClass: 'text-main' },
	{ family: 'danger', shade: '200', class: '!bg-danger-200', checkClass: 'text-main' },
	...
	{ family: 'danger', shade: '500', class: '!bg-danger-default', checkClass: 'text-white' },
	...
	{ family: 'info', shade: '50', class: '!bg-info-subtle', checkClass: 'text-main' },
	{ family: 'info', shade: '100', class: '!bg-info-100', checkClass: 'text-main' },
	{ family: 'info', shade: '200', class: '!bg-info-200', checkClass: 'text-main' },
	...
	{ family: 'info', shade: '500', class: '!bg-info-default', checkClass: 'text-white' },
	...
	{ family: 'orange', shade: '50', class: '!bg-orange-subtle', checkClass: 'text-main' },
	{ family: 'orange', shade: '100', class: '!bg-orange-100', checkClass: 'text-main' },
	{ family: 'orange', shade: '200', class: '!bg-orange-200', checkClass: 'text-main' },
	{ family: 'orange', shade: '300', class: '!bg-orange-300', checkClass: 'text-main' },
	{ family: 'orange', shade: '400', class: '!bg-orange-400', checkClass: 'text-white' },
	{ family: 'orange', shade: '500', class: '!bg-orange-default', checkClass: 'text-white' },
	...
	{ family: 'neutral', shade: '50', class: '!bg-neutral-50', checkClass: 'text-main' },
	{ family: 'neutral', shade: '100', class: '!bg-neutral-100', checkClass: 'text-main' },
	{ family: 'neutral', shade: '200', class: '!bg-neutral-200', checkClass: 'text-main' },
	{ family: 'neutral', shade: '300', class: '!bg-neutral-300', checkClass: 'text-main' },
	{ family: 'neutral', shade: '400', class: '!bg-neutral-400', checkClass: 'text-main' },
