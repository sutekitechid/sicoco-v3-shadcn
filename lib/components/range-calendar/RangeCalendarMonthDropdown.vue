...
<template>
	<Dropdown :model-value="selectedMonth" :data-cy="monthDropdownDataCy" :data-testid="monthDropdownDataTestid">
		<template #trigger="{ open }">
			<div
				class="flex items-center w-28 h-8 border-[1px] border-main justify-between gap-x-1.5 rounded px-2 py-2 shadow-sm transition duration-150 ease-in-out focus:border-primary-200 focus:ring-2 focus:ring-primary-50 bg-transparent dark:bg-neutral-100 hover:bg-neutral-100"
			>
