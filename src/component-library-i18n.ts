import type { LibraryTranslationParams, TranslationAdapter } from '../lib/i18n'

export const componentLibraryI18n: TranslationAdapter = {
	t(key, params) {
		switch (key) {
			...
			case 'datePicker.clearDate': return 'Hapus tanggal'
